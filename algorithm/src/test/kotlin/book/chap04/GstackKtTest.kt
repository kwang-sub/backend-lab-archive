...
import book.chap04.question.Gstack
...
class GstackKtTest {
    ...
    private lateinit var intStack: Gstack<Int>
    ...
    fun pushTest() {
        ...
        assertThatThrownBy { intStack.push(10123) }.isInstanceOf(Gstack.OverflowGException::class.java)
    }
    ...
    fun popTest() {
        ...
        assertThat(size).isEqualTo(0)
        assertThatThrownBy { intStack.pop() }.isInstanceOf(Gstack.EmptyGException::class.java)
    }
